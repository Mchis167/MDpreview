...
var init_webp_enc_simd = __esm({
  "node_modules/@jsquash/webp/codec/enc/webp_enc_simd.js"() {
    Module = (() => {
      ...
      return (function(Module4 = {}) {
        var Module4 = typeof Module4 != "undefined" ? Module4 : {};
        var readyPromiseResolve, readyPromiseReject;
        Module4["ready"] = new Promise(function(resolve, reject) {
        ...
        var err = Module4["printErr"] || console.warn.bind(console);
        Object.assign(Module4, moduleOverrides);
        moduleOverrides = null;
        if (Module4["arguments"]) arguments_ = Module4["arguments"];
        if (Module4["thisProgram"]) thisProgram = Module4["thisProgram"];
        if (Module4["quit"]) quit_ = Module4["quit"];
        var wasmBinary;
        if (Module4["wasmBinary"]) wasmBinary = Module4["wasmBinary"];
        ...
        function preRun() {
          if (Module4["preRun"]) {
            if (typeof Module4["preRun"] == "function") Module4["preRun"] = [Module4["preRun"]];
        ...
        function postRun() {
          if (Module4["postRun"]) {
            if (typeof Module4["postRun"] == "function") Module4["postRun"] = [Module4["postRun"]];
        ...
        function createWasm() {
          ...
          function receiveInstance(instance, module) {
            ...
            Module4["asm"] = exports;
            wasmMemory = Module4["asm"]["x"];
            updateMemoryViews();
            wasmTable = Module4["asm"]["D"];
            addOnInit(Module4["asm"]["y"]);
        ...
        function init_emval() {
          ...
          Module4["get_first_emval"] = get_first_emval;
        }
        ...
        InternalError = Module4["InternalError"] = extendError(Error, "InternalError");
        embind_init_charCodes();
        BindingError = Module4["BindingError"] = extendError(Error, "BindingError");
        init_emval();
        ...
        var ___wasm_call_ctors = function() {
          return (___wasm_call_ctors = Module4["asm"]["y"]).apply(null, arguments);
        };
        var _malloc = function() {
          return (_malloc = Module4["asm"]["z"]).apply(null, arguments);
        };
        var _free = function() {
          return (_free = Module4["asm"]["A"]).apply(null, arguments);
        };
        var ___getTypeName = Module4["___getTypeName"] = function() {
          return (___getTypeName = Module4["___getTypeName"] = Module4["asm"]["B"]).apply(null, arguments);
        };
        var __embind_initialize_bindings = Module4["__embind_initialize_bindings"] = function() {
          return (__embind_initialize_bindings = Module4["__embind_initialize_bindings"] = Module4["asm"]["C"]).apply(null, arguments);
        };
        var ___errno_location = function() {
          return (___errno_location = Module4["asm"]["__errno_location"]).apply(null, arguments);
        };
        var ___cxa_is_pointer_type = function() {
          return (___cxa_is_pointer_type = Module4["asm"]["E"]).apply(null, arguments);
        };
        var dynCall_jiiii = Module4["dynCall_jiiii"] = function() {
          return (dynCall_jiiii = Module4["dynCall_jiiii"] = Module4["asm"]["F"]).apply(null, arguments);
        };
        var calledRun;
        ...
        function run() {
          ...
          function doRun() {
            ...
            if (Module4["onRuntimeInitialized"]) Module4["onRuntimeInitialized"]();
            postRun();
          }
        ...
        if (Module4["preInit"]) {
          if (typeof Module4["preInit"] == "function") Module4["preInit"] = [Module4["preInit"]];
          while (Module4["preInit"].length > 0) {
            Module4["preInit"].pop()();
          }
        }
        run();
        return Module4.ready;
      });
    })();
...
var Module3 = (() => {
  ...
  return (function(moduleArg = {}) {
    ...
    var dynCall_jiji = Module4["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module4["dynCall_jiji"] = wasmExports["J"])(a0, a1, a2, a3, a4);
    var calledRun;
    dependenciesFulfilled = function runCaller() {
      if (!calledRun) run();
      if (!calledRun) dependenciesFulfilled = runCaller;
...
var mozjpeg_enc_default = Module3;
...
async function init2(module, moduleOptionOverrides) {
  ...
  emscriptenModule2 = initEmscriptenModule2(mozjpeg_enc_default, actualModule, actualOptions);
}
...
async function initMT(moduleOrPath) {
  const { default: init4, initThreadPool: initThreadPool2, optimise: optimise4, optimise_raw: optimise_raw3 } = await Promise.resolve().then(() => (init_squoosh_oxipng(), squoosh_oxipng_exports));
  await init4(moduleOrPath);
...
async function initST(moduleOrPath) {
  const { default: init4, optimise: optimise4, optimise_raw: optimise_raw3 } = await Promise.resolve().then(() => (init_squoosh_oxipng2(), squoosh_oxipng_exports2));
  await init4(moduleOrPath);
  return { optimise: optimise4, optimise_raw: optimise_raw3 };
}
var wasmReady;
async function init3(moduleOrPath) {
  var _a;
  if (!wasmReady) {
...
async function optimise3(data, options = {}) {
  ...
  const { optimise: optimise4, optimise_raw: optimise_raw3 } = await init3();
...
var _isWebpInit = false;
var _isJpegInit = false;
