...
2.  **Cập nhật file (Update CHANGELOG.md)**:
    ...
    *   **Thời gian chi tiết**: Sử dụng định dạng `YYYY-MM-DD HH:mm` (ví dụ: `## [Unreleased] — 2026-04-23 00:20`).
...
*   **Không ghi đè**: Mọi phần mới phải được thêm vào như một block mới hoặc append vào block `Unreleased` hiện có mà không làm mất dữ liệu trước đó.
